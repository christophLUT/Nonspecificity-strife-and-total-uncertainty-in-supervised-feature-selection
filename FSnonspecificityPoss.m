function [ranking,I]=FSnonspecificityPoss(data,v,c,p)
% Function to calculate nonspecificity values according to possibility
...
% ranked third)
% I: information transmission values (nonspecifity values for each feature)
...
for k=1:l % classes
    for i=1:t % features
        ns1(i,k)=nonspecificityPoss(s1(1:lc(k),i,k)); % [subset samples; changed 23.07.2020]
        nsf1(i,k)=nonspecificityPoss(s1f(:,i,k));
    end
end
